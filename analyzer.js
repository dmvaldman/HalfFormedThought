...
const sampleBlocks = [
  {
    "id": "MPEAkBuLpT",
    "text": "Essay: Interpolation vs Extrapolation"
  },
  {
    "id": "dw3MySS4aD",
  ...
  {
    "id": "3lvy-TP5VE",
    "text": "Hinton student learning more than teacher"
  },
  {
    "id": "xfSTfErYqI",
    "text": "Distilling the knowledge in a neural network (2015)"
  },
  {
    "id": "ydlEY9MoHE",
  ...
  {
    "id": "8_fkYLWAXe",
    "text": "\"The generalization is already there in the special case. What you learn is to inhibit the special case so that then you can have connections to new cases. Generalization is not learning something new, it is inhibiting connections to the old special cases\" - Lakoff"
  },
  {
    "id": "wv8-_IPpHo",
    "text": "https://youtu.be/GjTTET_MUL8?si=a1wwqyd-tgI02Qf8&amp;t=6600"
  },
  {
    "id": "pjd2dhsTkA",
  ...
  {
    "id": "4a4xEu74Qg",
    "text": "“The limits of my language mean the limits of my world” - Wittgenstein"
  },
  {
    "id": "ZruvtVgAoK",
    "text": "But what are the limits of one's language? Recombinations go quite far."
  },
  {
    "id": "b7RNRoLenA",
  ...
  {
    "id": "y3spoZEaus",
    "text": "Discovery is equating disparity."
  },
  {
    "id": "tH-iGy5JFU",
    "text": "e.g. equivalence of space and time, temperature as avg velocity of particles"
  },
  {
    "id": "FD7paJcUOH",
    "text": "social examples:"
  },
  {
    "id": "9oer1OzQcz",
    "text": "Freud - everything is sex"
  },
  {
    "id": "RZA1lkG7-1",
    "text": "Aristotle - Power is actually virtue"
  },
  {
    "id": "auQMrzjI_Z",
    "text": "Aristotle - Health of the body is really the health of the soul"
  },
  {
    "id": "NYdQ1eW1O_",
    "text": "Utilitarianism - what's moral is what's in the interest of the majority"
  },
  {
    "id": "j9wzd9BPlS",
  ...
  {
    "id": "PW3JeB3l__",
    "text": "Quantum Mechanics - no one can really say they \"understand\" it and it's been 100 years. We have narratives, but do they map on to reality? Are our narratives complete?"
  },
  {
    "id": "DP21e_aZxb",
  ...
  {
    "id": "9muzY1gE-_",
    "text": "extrapolation along a circle = interpolation in the exponential map e^{i*theta}"
  },
  {
    "id": "4GX3fdxHCB",
    "text": "there is always some map to a linear space (locally) where interpolation is equivalent to extrapolation along a manifold"
  },
  {
    "id": "8-fBHq1kUE",
    "text": "References:"
  ...
  {
    "id": "UkHoBOfj9S",
    "text": "Wittgenstein's Tractatus Logico-Philosophicus"
  }
]
